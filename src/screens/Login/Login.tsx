    ...
    return (
        <div className="flex flex-col items-start relative bg-[#faf8ff]">
            <div className="flex min-h-[1024px] items-center justify-center px-12 py-[90px] relative self-stretch w-full flex-[0_0_auto]">
                ...
                <div className="flex flex-col max-w-md w-[448px] items-start gap-0 relative">
                    ...
                    <form
                        ...
                        className="flex flex-col items-start gap-8 p-10 relative self-stretch flex-[0_0_auto] bg-[#ffffffcc] border border-solid border-[#c3c6d633] backdrop-blur-md backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(12px)_brightness(100%)] w-full rounded-[32px] mt-6"
                    >
                            ...
                            <div className="relative self-stretch w-full h-[84px]">
                                ...
                                <div className="flex flex-col w-full items-start absolute top-7 left-0">
                                    <div className="flex items-start justify-center pl-12 pr-4 py-[18px] relative self-stretch w-full flex-[0_0_auto] bg-[#f2f3ff] rounded-[32px] overflow-hidden">
                                        <input
                                            id="email"
                                            className="relative grow border-[none] [background:none] self-stretch mt-[-1.00px] [font-family:'Inter-Regular',Helvetica] font-normal text-black text-base tracking-[0] leading-[normal] p-0 outline-none"
                                    ...
                                    <div className="inline-flex h-full items-center absolute top-0 left-4">
                                        <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
                                            <svg
                                                className="relative w-4 h-4 text-[#6b7280]"
                                                viewBox="0 0 24 24"
                                                fill="none"
