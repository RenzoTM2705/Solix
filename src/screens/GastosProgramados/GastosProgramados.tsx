                        ...
                        <div className="flex flex-col gap-3 bg-[#f2f3ff] px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                            ...
                            <div className="flex gap-1 sm:gap-2 items-center justify-center sm:justify-start shrink-0 relative z-[182]">
                                <button
                                    ...
                                    className="flex w-[36px] sm:w-[40px] h-[36px] sm:h-[40px] justify-center items-center shrink-0 flex-nowrap rounded-full border-solid border border-[rgba(195,198,214,0.3)] relative z-[183] hover:bg-[#f2f3ff] disabled:cursor-not-allowed disabled:opacity-50 transition-colors"
                                >
